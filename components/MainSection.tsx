...
const MainSection = () => {
  ...
  return (
    <>
      <div className="md:flex flex-wrap items-start lg:flex-nowrap lg:justify-center w-[80%] mx-auto gap-12 gap-y-5 mt-24  hidden">
        <div className="md:-mt-[85px]">
          <div className="flex flex-col pt-7 items-start  gap-y-3 ">
            <h2 className="flex items-center gap-1 text-lg md:text-xl text-red-500 mb-5 font-semibold">
              {" "}
              <span className="bg-gray-300 px-[3.5px] py-2 mt-2"></span> سایر
              محصولات{" "}
            </h2>
            <div
